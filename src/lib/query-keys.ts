...
export const queryKeys = {
  ...
  users: (userId: string | null) =>
    [...queryKeys.all, "users", userId] as const,

  // Account keys
  accounts: (userId: string | null) =>
    [...queryKeys.users(userId), "accounts"] as const,
  ...
  accountHistory: (
    ...
    [
      ...queryKeys.account(userId, accountId ?? ""),
      "history",
      timeRange,
    ] as const,
  ...
  // Net worth keys
  networth: (userId: string | null) =>
    [...queryKeys.users(userId), "networth"] as const,
...
export type AccountPerformanceKey = ReturnType<
  typeof queryKeys.accountPerformance
>;
export type NetworthPerformanceKey = ReturnType<
  typeof queryKeys.networthPerformance
>;

/**
 * Helper to invalidate all queries for a user
 */
export const getUserQueryKey = (userId: string | null) =>
...
export const getAccountQueryKeys = (userId: string | null) => ({
  ...
  performance: (timeRange: TimeRange) =>
    queryKeys.accountPerformance(userId, timeRange),
});
...
export const getNetworthQueryKeys = (userId: string | null) => ({
  ...
  history: (timeRange: TimeRange) =>
    queryKeys.networthHistory(userId, timeRange),
  chart: (timeRange: TimeRange) => queryKeys.networthChart(userId, timeRange),
  performance: (timeRange: TimeRange) =>
    queryKeys.networthPerformance(userId, timeRange),
});
